...
NAN_MODULE_INIT(InitAll) {
  ...
  EXPORT_NUMBER_VALUE(crypto_stream_xor_KEYBYTES, crypto_stream_xor_keybytes())
  EXPORT_NUMBER_VALUE(crypto_stream_xor_NONCEBYTES, crypto_stream_xor_noncebytes())
  ...
  EXPORT_NUMBER_VALUE(crypto_stream_xsalsa20_xor_KEYBYTES, crypto_stream_xsalsa20_xor_keybytes())
  EXPORT_NUMBER_VALUE(crypto_stream_xsalsa20_xor_NONCEBYTES, crypto_stream_xsalsa20_xor_noncebytes())
  ...
  EXPORT_NUMBER_VALUE(crypto_stream_chacha20_xor_KEYBYTES, crypto_stream_chacha20_xor_keybytes())
  EXPORT_NUMBER_VALUE(crypto_stream_chacha20_xor_NONCEBYTES, crypto_stream_chacha20_xor_noncebytes())
  ...
  EXPORT_NUMBER_VALUE(crypto_stream_xchacha20_xor_KEYBYTES, crypto_stream_xchacha20_xor_keybytes())
  EXPORT_NUMBER_VALUE(crypto_stream_xchacha20_xor_NONCEBYTES, crypto_stream_xchacha20_xor_noncebytes())
